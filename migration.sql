...
-- ============================================
-- INDEXES FOR RELATIONSHIPS & PERFORMANCE
-- ============================================
...
-- SOFT DELETE INDEXES
-- ============================================
-- Hybrid Delete Architecture:
-- - Business entities use SOFT DELETE (deleted_at column)
-- - Operational/logging entities use HARD DELETE (no deleted_at)
-- 
-- These indexes optimize queries with WHERE deleted_at IS NULL
-- and support efficient restoration of soft-deleted records.
